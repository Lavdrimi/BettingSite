...
using BettingSite.ProfilesAutomapper;
using BettingSite.Repositories.Interfaces;
using BettingSite.Repositories.Repositories;
using BettingSite.Services.Interfaces;
using BettingSite.Services.Services;
...
namespace BettingSite
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BettingSiteContext>(options =>
